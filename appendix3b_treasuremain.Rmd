---
title: 'DeBruine/Barr Appendix 3b modified for Treasure Hunt 2 or 4 blocks learning'
author: "DVM Bishop"
output: rmarkdown
---
...
library(groundhog)
groundhog.library("tidyverse","2020-12-01")    # data wrangling and visualisation
groundhog.library("lme4","2020-12-01")        # model specification / estimation
groundhog.library("afex","2020-12-01")        # anova and deriving p-values from lmer
groundhog.library("broom.mixed","2020-12-01")  # extracting data from model fits 
groundhog.library("faux","2020-12-01")       # data simulation
...
```{r prob2param}
#beta definitions corrected on 5th Jan 2021
