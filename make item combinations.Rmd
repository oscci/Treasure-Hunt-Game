...
codeconvert <- 0 #usually set to 1, but for testing script want to avoid changing values so set to 0
if(codeconvert==1){
...
writetable <- 1 #make writing sheets optional, in case just testing script
if(writetable==1){
